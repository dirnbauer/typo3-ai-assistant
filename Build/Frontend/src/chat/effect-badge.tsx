...
/**
 * What a tool call will do to this installation. The wording is the runtime's
 * own: nr-llm decides whether a call may be retried from exactly this class,
 * and a badge that reads more comfortably than the gate behaves is worse than
 * none.
 */
const EFFECTS: Record<ToolEffect, { label: string; explanation: string; icon: typeof EyeIcon; className: string }> = {
  read_only: {
    label: 'Reads',
  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <Badge variant="outline" className={cn('gap-1 rounded-full px-1.5 font-normal', tone, className)}>
